...
if (!expected.react.test(webPkg.dependencies.react)) failures.push(`React ${webPkg.dependencies.react}; expected 19.2.x`);
if (!expected.reactDom.test(webPkg.dependencies['react-dom'])) failures.push(`React DOM ${webPkg.dependencies['react-dom']}; expected 19.2.x`);
